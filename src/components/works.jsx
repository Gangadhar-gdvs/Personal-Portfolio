...
import img from "./assets/images/ProCodrr.webp"
import img1 from "./assets/images/eazygrad.webp"
import img2 from "./assets/images/harigurus.webp"
import img3 from "./assets/images/web-dev-english.webp"
import img4 from "./assets/images/pioneer-digital.webp"
const LatestWorks = () => {
  return (
    <section className="project_bg  mx-auto px-4 relative pb-8 sm:pb-16">
      <h2 className="project_title text-3xl sm:text-[40px]  relative z-10 font-bold px-4 py-2 w-max mx-auto text-center text-[#1788ae] sm:border-b-2 border-[#1788ae]">
        Projects
      </h2>
      <div className="flex flex-col sm:flex-row gap-4 mt-8 sm:gap-[80px] items-center sm:mt-20 relative">
        ...
        <div className="w-full">
          ...
          <ul className="flex flex-wrap gap-2 mt-2">
            {['#react.js', '#express.js', '#node.js', '#swiper.js', '#mongoDB', '#mongoose', '#css', '#javascript', '#figma'].map((tag) => (
      ...
      {/* Repeat similar structure for EazyGrad, Harigurus, Web Dev English, and Pioneer Digital */}
      {/* Example for EazyGrad */}
      ...
      {/* Repeat similar structure for Harigurus, Web Dev English, and Pioneer Digital */}
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        <div className="h-[1px] left-1/4 right-1/2 bg-[#1788ae] absolute top-1/2 hidden sm:block"></div>
        ...
        <a href="#" className="flex w-full relative justify-center sm:justify-start">
          <div className="flex flex-col items-center relative group hover:scale-105 ease-in-out sm:mr-auto duration-200">
            <img
              className="max-w-[400px] w-full mr-auto relative z-10 drop-shadow-[0_0 px_60px_rgba(59,130,246,0.6)]"
              src={img2}
              alt=""
            />
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        ...
        <a href="#" className="order-1 sm:order-2 flex w-full relative justify-center sm:justify-start">
          <div className="flex flex-col items-center relative ```jsx
          group sm:hover:scale-105 ease-in-out duration-200 sm:ml-auto">
            <img
              className="max-w-[400px] w-full relative z-10 drop-shadow-[0_0px_60px_rgba(59,130,246,0.6)]"
              src={img3}
              alt=""
